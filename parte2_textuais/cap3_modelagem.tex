...
\commentib{Fale bem mais sobre esse processo... deixe claro qual é a função que você estimou, mostre os outros gráficos, mostre a superfície estimada...}
...
\commentib{VOcê deve inserir gráficos com a resposta do simulador e se possível comparando qualitativamente e quantitativamente com o sistema real.}
