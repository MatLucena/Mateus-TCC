...
\subsection{Implementing a Remote Laboratory Experience Into a Joint Engineering Degree Program: Aerodynamic Levitation of a Beach Ball}
...
\subsection{Design of a Low-Cost Air Levitation System for Teaching Control Engineering}
...
\subsection{Identificação de Sistemas Utilizando Métodos de Subespaços}
